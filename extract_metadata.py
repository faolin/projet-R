...
light_df = df.loc[:,['asin', 'reviewerID', 'reviewerName','reviewText']]

light_df = light_df.rename(index=str, columns={"rewiewerID": "customerID", "reviewerName": "customerName",'reviewText':'Text'})

light_df.to_csv('data/data_transformer.csv', sep=',')
